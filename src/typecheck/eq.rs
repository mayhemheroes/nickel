...
fn contract_eq_bounded(
    ...
    if crate::term::SharedTerm::ptr_eq(&t1.term, &t2.term) {
        println!("ptr equality!");
        return true;
    }

    println!("No physical equality. True comparison...");
    ...
    match (t1.as_ref(), t2.as_ref()) {
        ...
        (Op1(UnaryOp::StaticAccess(id1), t1), Op1(UnaryOp::StaticAccess(id2), t2)) => {
            println!(
                "Record static access. Id equality: {}. Checking operands...",
                id1 == id2
            );
