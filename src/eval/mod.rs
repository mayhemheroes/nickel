...
/// limit (in the number of variables followed). This function is used to determine if a record
/// field is an optional field without definition, and should thus be ignored.
